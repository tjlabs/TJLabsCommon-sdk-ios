...
class TJLabsPeakValleyDetector: NSObject {
    ...
    var lastPeakValley: PeakValleyStruct = PeakValleyStruct(type: Type.PEAK, timestamp: Double.greatestFiniteMagnitude, pvValue: Double.leastNormalMagnitude)
    ...
    func isGlobalPeak(lastPeak: PeakValleyStruct, localValley: PeakValleyStruct) -> Bool {
        ...
        return (amp > UVDConstants.AMP_THRESHOLD) && (time > UVDConstants.TIME_THRESHOLD)
    }
