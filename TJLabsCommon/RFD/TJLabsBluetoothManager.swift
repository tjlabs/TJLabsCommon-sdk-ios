...
public class TJLabsBluetoothManager: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    public func initBle(activateNI: Bool) -> (Bool, String) {
        let localTime: String = TJLabsUtilFunctions.shared.getLocalTimeString()
        let isSuccess: Bool = true
        let message: String = localTime + " , " + CommonConstants.COMMON_HEADER + " Success : Bluetooth Initialization"
    ...
    public func startScan(option: BLEScanOption) {
    ...
    public func getBLEDataTJ() -> [String: [[Double]]] {
        return self.bleDictionaryTJ
    }
    
    public func getBLEDataNI() -> [String: [[Double]]] {
